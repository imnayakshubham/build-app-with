...
export function generateConfig(projectPath, answers) {
    const configContent = `// SECURITY WARNING: All default values below MUST be changed in production!
// Use environment variables to override these development defaults.
